<template>
	<view>
		...
		<navigator url="/pages/senior/jingdong">
			<view class="demo-li">仿【京东】下拉刷新上拉加载<text class="demo-tip">自定义mescroll组件</text></view>
		</navigator>
		
		<navigator url="/pages/senior/taobao">
			<view class="demo-li">仿【淘宝】下拉刷新上拉加载<text class="demo-tip">自定义mescroll组件</text></view>
		</navigator>
	</view>
</template>
