<template>
    <div>
        ...
        <div class="top-warp">
            ...
            <div class="nav">
                <div v-for="(tab,index) in mescrollArr"
                     :key="tab.title"
        ...
        <mescroll-vue v-for="(content,index) in mescrollArr"
            ...
            <ul v-bind:id="'dataList'+index">
                <li class="data-li" v-for="pd in content.list" :key="pd.id">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                mescrollArr: [
                    { title: "全部", mescroll: null, list: [], isListInit: false }, // 全部
                    { title: "奶粉", mescroll: null, list: [], isListInit: false }, // 奶粉
                    { title: "面膜", mescroll: null, list: [], isListInit: false }, // 面膜
                    { title: "图书", mescroll: null, list: [], isListInit: false } // 图书
                ],
                tabType: 0, // 菜单类型
            };
        },
