<template>
	<view>
		<!-- 模拟的标题 -->
		<image class="header" src="http://www.mescroll.com/img/meituan/header.jpg" mode="aspectFit"/>
		
		<mescroll-uni top="100" bottom="100" @down="downCallback" @up="upCallback" @init="mescrollInit">
			<!-- 模拟的内容 -->
			<image src="http://www.mescroll.com/img/meituan/meituan1.jpg" mode="widthFix"/>
			<image src="http://www.mescroll.com/img/meituan/meituan2.jpg" mode="widthFix"/>
			<!-- 分页的数据列表 -->
		...
		<!-- 模拟的底部 -->
		<image class="footer" src="http://www.mescroll.com/img/meituan/footer.jpg" mode="aspectFit"/>
	</view>
</template>
...
<style>
	image{width: 100%;}
	.header{z-index: 9900;position: fixed;top: --window-top;left: 0;height: 100upx;background: #06c1ae;}
